...
const ERROR_MESSAGES: Record<string, string> = {
  auth:            en.authError,
  account_removed: en.authAccountRemoved,
}

export default function LoginCard({ errorCode }: { errorCode: string | null }) {
  const [loading, setLoading] = useState(false)
  const [error, setError]     = useState<string | null>(errorCode ? ERROR_MESSAGES[errorCode] ?? en.authError : null)
