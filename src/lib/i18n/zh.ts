...
export const zh: Partial<Translations> = {
  ...
  newChatInProject: '在此工作区中新建对话',
  projectDelete: '删除工作区',
  projectDeleteConfirm: '删除此工作区？其中的对话会保留并移回历史列表。',
  projectInstructions: '工作区说明',
  projectInstructionsHint: '此工作区内的每个对话都会遵循这些说明。',
  projectFiles: '工作区文件',
  projectFilesHint: '供此工作区内所有对话共用。仅支持图片和 PDF，最多 10 个文件 / 20 MB。',
  projectAddFile: '添加文件',
  projectFileTooMany: '每个工作区最多 10 个文件。',
  projectFileTotalTooLarge: '工作区文件总大小不能超过 20 MB。',
  moveToProject: '移至工作区',
  noProject: '不属于任何工作区',
