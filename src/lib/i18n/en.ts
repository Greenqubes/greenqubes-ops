export const en = {
  ...
  clientPOCPhone: 'Client Contact No.',
  ...
  uploading: 'Uploading…',
  uploadTypeRejected: 'That file type cannot be attached here.',
  uploadTooLarge: 'Videos must be under {mb}MB. Try a shorter clip.',
  uploadFailed: 'Upload failed — {reason}',
  fileDeleted: 'File deleted.',
  deleteFileConfirm: 'Delete this file? This cannot be undone.',
  deleteFileNotYours: 'You can only delete files you uploaded.',
  ...
  // ── Leave (HR) ─────────────────────────────────────────────────────────────
  leaveTitle: 'Leave',
  leaveSubtitle: 'Who is away, and when. Everyone else sees only "On leave" — never the reason.',
  leaveAdd: 'Add leave',
  // Button labels: the + icon already says "add", so the buttons carry only
  // the noun (Nic, 2026-09-09). leaveAdd above stays the modal's title.
  leaveAddShort: 'Leave',
  leaveEdit: 'Edit leave',
  leaveShow: 'Show',
  leaveHide: 'Hide',
  leaveShowMore: 'Show more',
  leaveUpcoming: 'Upcoming',
  leavePast: 'Past',
  leavePerson: 'Person',
  leaveFrom: 'From',
  leaveTo: 'To',
  leavePortion: 'Part of day',
  leavePortionFull: 'Full day',
  leavePortionAm: 'AM only',
  leavePortionPm: 'PM only',
  leaveFirstDay: 'First day',
  leaveLastDay: 'Last day',
  leaveType: 'Type',
  ...
  leaveNote: 'Note',
  leaveNotePlaceholder: 'Optional — only you and the admin can see this',
  leaveSave: 'Save',
  leaveCancel: 'Cancel',
  ...
  leavePastNone: 'No past leave',
  holidaysTitle: 'Public holidays',
  holidaysSubtitle: 'Singapore. Shown on the schedule as a label only — they do not block scheduling.',
  holidayAdd: 'Holiday',
  holidayName: 'Holiday name',
  holidayNone: 'No public holidays recorded',
  eventsTitle: 'Company events',
  eventsSubtitle: 'Retreats and shutdowns, shown on everyone\'s schedule.',
  eventAdd: 'Event',
