...
_Last updated: 2026-07-22 (feat-jobs — Workflow V2 Phase 3 FCFS Board implemented + smoke test PASSED on feat-workflow-v2)_
...
**Workflow V2 Phases 1 + 2 + 3 implemented, all smoke tests PASSED** on the `feat-workflow-v2` branch.
...
**Phase 4 (external installer links, sub-installers, task list, external POC bucket) is next** — the last phase before the clean-cut switchover.
