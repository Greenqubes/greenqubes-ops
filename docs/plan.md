...
_Last updated: 2026-07-30 (feat-jobs — Workflow V2 Phase 4 external links + sub-installers + task list PASSED; V2 build COMPLETE — regression test + clean-cut switchover next)_
...
**Workflow V2 Phases 1–4 implemented — the V2 build is COMPLETE, all smoke tests PASSED** on the `feat-workflow-v2` branch.
...
**Workflow V2 is fully built.** Next: a full V2 regression test (Phases 1–4 together on the preview), then the one-shot clean-cut switchover to dev/main.
